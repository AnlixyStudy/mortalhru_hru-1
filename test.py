...
JUMP_HEIGHT = 20  # Высота прыжка
# JUMP_COOLDOWN = 20  # Кулдаун для прыжков в кадрах
# JUMP_SPEED = 10  # Скорость подпрыгивания
...
player1_images = {
    "idle": pygame.image.load("images/hero1.png"),
...
while running:
    ...
    #     elif players[i].colliderect(platform):
